...
print(len(l))
plt.title("2D projection of Pierre Auger JF12 Backtracked background, E > 2EeV, nside = 15",fontsize=30)
#plt.title("Simulated Dataset using Shuffling Method, E > 5EeV, nside = 15",fontsize=30)
#plt.figure()
