...
- `combined_evrs_effectivearea.py` : This shows the distribution of effective distances at TARGER_ENERGY, shown on a log scale (y-axis). We use 221 locations which we have chosen from `Firstordercandidate.py`. The default value for TARGER_ENERGY would be 5 EeV.
