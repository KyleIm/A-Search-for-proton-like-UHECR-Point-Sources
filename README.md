...
-   `lima_Syenthetic.py` : This creates Sy_events_5EeV.csv` which used for `2DSyntheticprojection.py`, . This csv file is synthetic events used for synthetic event injection test.
