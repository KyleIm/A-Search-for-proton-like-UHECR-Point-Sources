...
ax.scatter(dL*-1, dB, s=20, label='Random Samples')
ax.scatter(l*-1, b, s=60, c='g', label='Origin')
ax.scatter(dl*-1, db, s=60, c='r', label='JF12 Sample')
...
plt.title("Random Paramater Sampling from Origin, E = 5EeV, 1000 samples", fontsize=35)
plt.show()
