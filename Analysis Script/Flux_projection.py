...
D_E = [5800,5550,4500,4250,4150,4100,4100,4100,4100,4100,4100,4100,4000,3900,3800,3750,3650,3600,3550,3500,3450,3350,3250,3150,3050,2950,2800,2650,2500,2300,2100,1900,1750,1500,1250,1050,800,500,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50]
...
df1=pd.read_csv('JF12_5EeVCut.csv')
dL=df1['dL'].values
dB=df1['dB'].values
...
plt.title(r"Flux Upper Limit projection, E > 5EeV, $N_{side}$ = 15",fontsize=30)
